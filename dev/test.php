...
<head>
    ...
    <title>HVACR Contractors | Find Your AC Repair Contractor</title>
...
<body>
    <span id="splash" class="splash gradient_grey justify-center">
        <span class="title">
            ...
            <img width="420" src="contractor-logo-type.svg" alt="HVACR Contractors">
        </span>
        <div>
    ...
    <footer class="container items-center">
        <span class="title">
            ...
            <img width="200" src="contractor-logo-type.svg" alt="HVACR Contractors">
        </span>
        <div class="footer__copy">
            <span class="text-lg b">HVACR Contractors</span>
